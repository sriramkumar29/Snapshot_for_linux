...
SNAPSHOT_RW=/path/to/local/backup/directory;
EXCLUDES=/path/to/local/exclude/file;
...
# rotating snapshots of the directory (fixme: this should be more general)
...
$RSYNC                                             \
    ...
    /path/to/local/directory/ $SNAPSHOT_RW/hourly.0 ;

# step 5: update the mtime of hourly.0 to reflect the snapshot time
$TOUCH $SNAPSHOT_RW/hourly.0 ;

# and thats it for the directory.
